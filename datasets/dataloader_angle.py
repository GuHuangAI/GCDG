...
class AISTDataset_plot(object):
    ...
    @classmethod
    def plot_smpl_poses(cls, smpl_joints, save_path=None, save_type=None, fname=None, test=False, test_dir=None,
                        epoch=None):
        fig = cls.plot_joints(smpl_joints.reshape(-1, 24, 3), save_path, save_type, fname, test=test, test_dir=test_dir,
                              epoch=epoch)
